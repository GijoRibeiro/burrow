...
6. Add a folder that already contains a Git repository, create a terminal, and choose your agent. Sign into your own Claude or Codex account in Terminal view on first launch. Agents start in YOLO mode, allowing broad file and command access; use trusted project folders.
